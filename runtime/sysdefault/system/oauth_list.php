...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
	<div class="position"><span>系统</span><span>></span><span>多平台登录</span><span>></span><span>开发平台列表</span></div>
	<div class="field">
		...
		<tbody>
			<?php $query = new IQuery("oauth");$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
					...
					<td>
						<a href='<?php echo IUrl::creatUrl("/system/oauth_edit/id/".$item['id']."");?>'><img class="operator" src="<?php echo IUrl::creatUrl("")."views/".$this->theme."/skin/".$this->skin."/images/admin/icon_edit.gif";?>" alt="编辑" title="编辑" /></a>
					</td>
				</tr>
			<?php }?>
		</tbody>
