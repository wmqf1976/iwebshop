...
<div class="headbar">
	...
	<ul class='tab' name='conf_menu'>
		...
		<li><a href="javascript:select_tab('sms_conf');">短信设置</a></li>
	</ul>
</div>
<div class="content_box">
	...
	<div class="content form_content">
		...
		<form action="<?php echo IUrl::creatUrl("/system/save_conf/form_index/sms_conf");?>"  method="post" enctype='multipart/form-data' name='sms_conf'>
			<!--基本设置!-->
			<table class="form_table">
				<colgroup>
					<col width="150px" />
				...
				<tr>
					...
					<td>
						...
						<a href="http://www.aircheng.com" target="_blank" class="orange">立即联系客服购买</a>
					</td>
				</tr>
				<tr>
					<th>商户号：</th>
					<td><input type='text' class='normal' name='sms_userid' pattern='required' alt='' /><label>购买后分配的<用户ID></label></td>
				</tr>
				<tr>
					<th>用户名：</th>
...
<script type='text/javascript'>
	...
	$(function(){
		...
		//全部表单自动填入值
		var formNameArray = ['base_conf','shopping_conf','show_conf','mail_conf','system_conf','sms_conf'];
