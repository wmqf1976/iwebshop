	...
	<div class="content">
		<table id="list_table" class="list_table">
			...
			<tbody>
				...
				<?php $query = new IQuery("user as u");$query->join = "left join member as m on m.user_id = u.id";$query->fields = "m.*,u.username,u.email";$query->where = "m.status = 1 and $where";$query->order = "m.user_id desc";$query->page = "$page";$query->pagesize = "20";$items = $query->find(); foreach($items as $key => $item){?>
				<tr>
